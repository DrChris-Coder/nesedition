;===============================================================================
;                     RetroGameDev NES Edition chapter8_2
;===============================================================================
; NES ROM Header
.segment "HEADER"
...
; Code Segment
.segment "CODE"
  ; Include necessary library code for handling input, math, screen, and sprites
  .include "../../library/libDefines.asm"    ; Includes constants like color codes
  .include "../../library/libInput.asm"      ; Includes player input handling
...
gameMainUpdate:
  ...
  ; Player input and tank update logic
  LIBINPUT_UPDATE                ; Update player input (controller)
  jsr gameTanksUpdate            ; Update the tank based on player input
