;===============================================================================
;                     RetroGameDev NES Edition chapter6_1
;===============================================================================
; NES ROM Header
.segment "HEADER"
...
; Code Segment
.segment "CODE"
  ; Include necessary library code for handling screen functions
...
gameMainInit:
  ...
  LIBSCREEN_LOADPALETTE_AA BGPALETTE, Palette
  
  ; Load screen data to the left nametable
  LIBSCREEN_LOADNAMETABLE_AA NAMETABLE0, Screen
...
.segment "CHARS"
  ...
  ; This section will hold sprite and tile graphics. Currently, it loads a test screen
  .incbin "../../content/testbackground.chr"
